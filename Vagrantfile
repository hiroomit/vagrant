...
Vagrant.configure(2) do |config|
  ...
  config.vm.box = "taniguchi/trusty64"
  ...
  config.vm.network "forwarded_port", guest: 32768, host: 22222
  ...
  #    args: "-t eg_sshd"
  #  d.run "eg_sshd",
  #    args: "-p 32768:22 -p 8080:8080 --name 'test_sshd'"
  #   d.build_image "/vagrant/data/docker/eg_chef",
  #     args: "-t eg_chef"
  #   d.run "eg_chef",
  #     args: "-p 32768:22 -p 8080:8080 --name 'test_chef'"
  end
end
